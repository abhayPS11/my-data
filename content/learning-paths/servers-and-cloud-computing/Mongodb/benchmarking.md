...
```
**Purpose:** Prepares the database with initial records (default: 1,000) for benchmarking.
...
./bin/ycsb run mongodb -s \
  ...
  -p mongodb.url=mongodb://127.0.0.1:27017/ycsb
```
**Purpose:** Measures latency and throughput of mixed read/write operations (workloada = 50% read, 50% write).
