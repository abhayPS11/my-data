...
optional_hidden_info:
    ...
    other_info: There are no release notes for Linux/ARM64. Luajit can be built from source from version v2.1.0-beta3 on the Neoverse N1 via make.
