...
19999
```
The count **19999** reflects the total documents after inserting 10,000 initial records, adding 10,000 more, and deleting one (record: 100).

9. Measure Execution Time (Optional):
