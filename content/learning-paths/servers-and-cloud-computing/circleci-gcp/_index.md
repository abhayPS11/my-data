...
prerequisites:
  ...
  - Basic understanding of CircleCI concepts such as 
    ...
    [jobs](https://circleci.com/docs/2.0/jobs-steps/), 
    [resource classes](https://circleci.com/docs/2.0/runner-concepts/#resource-classes), and 
    [runners](https://circleci.com/docs/2.0/runner-overview/)
