...
{{% notice Note %}} You'll need the External IP address displayed in the list to access your OpenTelemetryapplication later.{{% /notice %}}
...
A browser window opens with a terminal shell connected to your VM. You're now ready to install OpenTelemetry.
