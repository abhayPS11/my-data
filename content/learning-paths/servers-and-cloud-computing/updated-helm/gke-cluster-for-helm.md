...
It focuses on **cloud-based Kubernetes**, which is different from the local KinD setup used earlier.

This environment is used to deploy:
- PostgreSQL
- Redis
- NGINX  
using the same custom Helm charts.
