...
In this section, you create a Firewall Rule within Google Cloud Console to expose TCP port 8080.
...
![Create a firewall rule](images/firewall-rule1.png "Create a firewall rule")
...
![Create a firewall rule](images/network-rule2.png "Creating the TCP/8080 firewall rule")

Next, enter "allow-tcp-8080" in the **Target tags** text field. Set **Source IPv4 ranges** to "0.0.0.0/0".

![Create a firewall rule](images/network-rule3.png "Creating the TCP/8080 firewall rule")
