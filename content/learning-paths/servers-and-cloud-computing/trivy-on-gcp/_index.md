...
who_is_this_for: This learning path is designed for developers and DevOps engineers who want to integrate security scanning into CI/CD pipelines for multi-architecture container images, especially when migrating workloads from x86_64 to Arm64.

learning_objectives:
    - Provision an Azure Arm64 virtual machine using Azure console, with Ubuntu Pro 24.04 LTS as the base image
    - Build multi-architecture container images (amd64 + arm64) for Azure Cobalt 100
