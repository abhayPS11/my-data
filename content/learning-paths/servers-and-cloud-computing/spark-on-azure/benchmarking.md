...
- For Arm64, performance was consistent in both container and virtual machine environments.
- For x86, benchmark results were also consistent across container and virtual machine.
{{% /notice %}}
