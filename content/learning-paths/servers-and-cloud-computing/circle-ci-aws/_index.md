...
learning_objectives:
  - Provision an AWS EC2 Arm64 virtual machine (Graviton2, e.g., m6g.large)
  ...
  - Define and execute a single CircleCI job (`test-Arm64`) using a machine executor
  - Check CPU architecture and execute a basic script (`hello.sh`) to confirm the runner is operational
